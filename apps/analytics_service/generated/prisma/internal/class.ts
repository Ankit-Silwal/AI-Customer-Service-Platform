...
config.runtimeDataModel = JSON.parse("{\"models\":{\"MetricEvent\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"workspaceId\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"type\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"MetricEvent.findUnique\",\"MetricEvent.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"MetricEvent.findFirst\",\"MetricEvent.findFirstOrThrow\",\"MetricEvent.findMany\",\"data\",\"MetricEvent.createOne\",\"MetricEvent.createMany\",\"MetricEvent.createManyAndReturn\",\"MetricEvent.updateOne\",\"MetricEvent.updateMany\",\"MetricEvent.updateManyAndReturn\",\"create\",\"update\",\"MetricEvent.upsertOne\",\"MetricEvent.deleteOne\",\"MetricEvent.deleteMany\",\"having\",\"_count\",\"_min\",\"_max\",\"MetricEvent.groupBy\",\"MetricEvent.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"workspaceId\",\"type\",\"createdAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more MetricEvents
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.metricEvent`: Exposes CRUD operations for the **MetricEvent** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more MetricEvents
    * const metricEvents = await prisma.metricEvent.findMany()
    * ```
    */
  get metricEvent(): Prisma.MetricEventDelegate<ExtArgs, { omit: OmitOpts }>;
}
